...
router.post('/change-availablity',teacherController.changeAvailablity)
router.get('/list-teachers',teacherController.listTeachers)
router.post('/login-teacher',teacherController.login_teacher)
router.post('/appointments',authTeacher.authteacher,teacherController.appointmentsTeacher)
...
router.post('/update-profile',authTeacher.authteacher,teacherController.updateTeacherProfile)
